...
bool HelloWorld::init()
{
	...
	// start of file reading date editor 
	// load file
	unsigned long size = 0;
	char * pJsonData = (char*)CCFileUtils::sharedFileUtils()->getFileData("testDataEditor.json", "r", &size);

	// create CCArray
	CCArray * pJsonArrays = CCArray::create();
	//create json
	Json * pJson = Json_create(pJsonData);
	// clear and destroy pJsonData
	delete [] pJsonData;
	pJsonData = NULL;
	...
	// end of file reading date editor
